...
public class Base64Nove {
     ...
     * only valid characters within the Base64Nove alphabet.
     *
     * @param arrayOctect byte array to test
     * @return true if all bytes are valid characters in the Base64Nove
     ...
     *
     * @param binaryData binary data to encode
     * @return Base64Nove characters chunked in 76 character blocks
     */
     ...
     * characters in the Base64Nove alphabet.
     *
     * @param pArray A byte array containing Base64Nove character data
     ...
     * @return Base64Nove-encoded data.
     */
    ...
    /**
     * Decodes Base64Nove data into octects
     *
     * @param base64Data Byte array containing Base64Nove data
     * @return Array containing decoded data.
     */
    @SuppressWarnings("all")
    public static byte[] decodeBase64(byte[] base64Data) {
        // RFC 2045 requires that we discard ALL non-Base64Nove characters
     ...
     * @return A byte array containing only Base64Nove character data
     */
     ...
     * @return
     */
    public static String smipleEncode(String str) {
     ...
     * @return
     */
    public static String smipleDecode(String cryptoStr) {
        if (cryptoStr == null || cryptoStr.length() == 0) {
            return null;
        }
        try {
            return new String(decode(cryptoStr.getBytes(StandardCharsets.UTF_8)));
        } catch (UnsupportedOperationException e) {
            return null;
        }
    }
    ...
    /*public static String encode(String str) {
        String baseStr = new String(encode(str.getBytes(StandardCharsets.UTF_8)));
        String tempStr = Digest.digest(str).toUpperCase();
        String result = tempStr + baseStr;
        return new String(encode(result.getBytes(StandardCharsets.UTF_8)));
    }*/
     ...
     * Decodes Base64Nove data into octects
     *
     * @param encoded string containing Base64Nove data
    ...
    /**
     * remove WhiteSpace from MIME containing encoded Base64Nove data.
     *
